...
button_size = 60
play_button = pygame.transform.scale(pygame.image.load(os.path.normpath('img/icon/play.png')),
                                     (button_size, button_size))
pause_button = pygame.transform.scale(pygame.image.load(os.path.normpath('img/icon/pause.png')),
                                      (button_size, button_size))
...
covers = ['img/cover/billie_jean.jpg', 'img/cover/yesterday_cover.jpg', 'img/cover/wlr_cover.jpeg',
          'img/cover/1993_cover.jpeg', 'img/cover/wlr_cover.jpeg']
album_cover_size = 275
album_cover = pygame.transform.scale(pygame.image.load(os.path.normpath(covers[current_song_index])),
...
while running:
    ...
    if pressed[pygame.K_LEFT]:
        ...
        play = True
        x = 0
        album_cover = pygame.transform.scale(pygame.image.load(covers[current_song_index]),
                                             (album_cover_size, album_cover_size))
